...
module.exports.util = {
  ...
  getDb: function(dbName, collection, config, operation){
      mongoClient.open(function(err, mongoClient) {
        var db = mongoClient.db(dbName);
        db.collection(collection, operation);
        mongoClient.close();
      });
      return new mongo.Db(dbName, new mongo.Server(config.db.host , config.db.port), dbParams);
  },
